<?php
/*REDACTED*/ // <-- your token
$default_repo = "Salesetelmarketing/ghatgpt";
$default_branch = "main";
$result = "";
...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    $commit_message = $_POST['commit'] ?? "Push from gist_manager";

    // Auto filename if blank
    if (!$fname) {
        $line = '';
        foreach (explode("\n",$content) as $l) {
...
<html>
<head>
<title>Gist Manager UI (Gist or Repo)</title>
<style>
...
<body>
<div class="panel">
<h2>Gist Manager UI<br><span style="font-size:15px;opacity:0.7;">Gist or Repo (Salesetelmarketing/ghatgpt)</span></h2>
<form method="post">
...
<div id="repoopts" style="display:none;">
    ...
    <input type="text" name="commit" value="Push from gist_manager">
</div>
